...
<html lang='en'>
	...
	<body style="dir:rtl;">
		...
		<div id='highScoreInGameText'>
			<div id='highScoreInGameTextHeader'><a  style="color:red; background-color:black; padding:5px; border:none; border-radius:6px; text-decoration:none; right:2%; top:2%; position:fixed; " href="{{url('/saveEarth/1')}}">بازگشت</a></div>
		</div>
