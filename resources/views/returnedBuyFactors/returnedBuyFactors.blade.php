                ...
                <legend  class="float-none w-auto legendLabel mb-0">انتخاب</legend>
                    ...
                    <span class="situation">
                        <fieldset class="border rounded">
                            <form action="{{url("/filterFactors")}}" method="get" id="filterRBuyFactorsForm">
                                @csrf
                                <input type="hidden" name="factType" value="2"/>
        ...
        <div class="col-sm-10 col-md-10 col-sm-10 contentDiv">
            ...
            <div class="row contentFooter">
                <div class="col-sm-12 mt-2 text-end"> 
                    <button class="sefOrderBtn btn btn-sm btn-success text-warning" onclick="factorHistoryRBuy('YESTERDAY')" value="YESTERDAY"> دیروز </button> 
                    <button class="sefOrderBtn btn btn-sm btn-success text-warning" onclick="factorHistoryRBuy('TODAY')" value="TODAY"> امروز </button> 
                    <button class="sefOrderBtn btn btn-sm btn-success text-warning" onclick="factorHistoryRBuy('TOMORROW')" value="TOMORROW"> فردا </button> 
                    <button class="sefOrderBtn btn btn-sm btn-success text-warning" onclick="factorHistoryRBuy('AFTERTOMORROW')" value="AFTERTOMORROW"> پس فردا </button> 
                    <button class="sefOrderBtn btn btn-sm btn-success text-warning" onclick="factorHistoryRBuy('HUNDRED')" value="HUNDRED"> صد تای آخر </button>
                </div>
            </div>
        </div>
    </div>
