    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="text-center header-modal border-bottom">
                <p class="modal-title p-1">ثبت کد معرف</p>
            </div>
            <div class="modal-body p-0">
                <h4>اگر معرف دارید لطفا کد معرف خودرا وارد کنید.</h4>
            <form action="{{url('/addIntroducerCode')}}" method="POST">
                    @csrf
                <div class="form-group p-2">
                    <div class="input-group">
                        <span class="input-text">کد معرف</span>
                        <input type="text" name="introCode" class="form-control">
                    </div>
                </div>
            </div>
            <div class="modal-footer p-1 border-0" >
                <button type="submit" class="btn btn-success">ادامه </button>
                <button type="submit" class="btn btn-success">خیر</a>
            </form>
            </div>
        </div>
    </div>
