                ...
                <legend  class="float-none w-auto legendLabel mb-0">انتخاب</legend>
                    ...
                    <span class="situation">
                        <fieldset class="border rounded">
                            <form action="{{url("/filterRFactors")}}" method="get" id="filterRFactorsForm">
                                @csrf
        ...
        <div class="col-sm-10 col-md-10 col-sm-10 contentDiv">
            ...
            <div class="row contentFooter">
                <div class="col-sm-12 mt-2 text-end"> 
                    <button class="sefOrderBtn btn btn-sm btn-success text-warning" onclick="factorHistoryR('YESTERDAY')" value="YESTERDAY"> دیروز </button> 
                    <button class="sefOrderBtn btn btn-sm btn-success text-warning" onclick="factorHistoryR('TODAY')" value="TODAY"> امروز </button> 
                    <button class="sefOrderBtn btn btn-sm btn-success text-warning" onclick="factorHistoryR('TOMORROW')" value="TOMORROW"> فردا </button> 
                    <button class="sefOrderBtn btn btn-sm btn-success text-warning" onclick="factorHistoryR('AFTERTOMORROW')" value="AFTERTOMORROW"> پس فردا </button> 
                    <button class="sefOrderBtn btn btn-sm btn-success text-warning" onclick="factorHistoryR('HUNDRED')" value="HUNDRED"> صد تای آخر </button>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-4">
                                <div class="input-group input-group-sm mb-1 filterItems">
                                    <span class="input-group-text" > انبار </span>
                                    <input type="hidden" name="factType" value="4">
