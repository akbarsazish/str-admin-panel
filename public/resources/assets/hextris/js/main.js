...
function showHelp() {
	...
	$("#inst_main_body").html("<div id = 'instructions_head' style='direction: rtl; text-align:right;'> چطوری بازی کنم؟ </div><p style='direction: rtl; text-align:right;'>هدف هکستریس جلوگیری از خروج بلوک ها از داخل شش ضلعی خاکستری بیرونی است.</p><p style='direction: rtl; text-align:right;'>" + (settings.platform != 'mobile' ? 'کلیدهای جهت دار راست و چپ را فشار دهید' : 'روی سمت چپ و راست صفحه ضربه بزنید') + " برای چرخاندن شش ضلعی." + (settings.platform != 'mobile' ? ' برای سرعت بخشیدن به سقوط بلوک، فلش رو به پایین را فشار دهید' : '') + " </p><p style='direction: rtl; text-align:right;'>بلوک ها را پاک کنید و با ایجاد 3 یا چند بلوک از همان رنگ، امتیاز بگیرید.</p><p style='direction: rtl; text-align:right;'>زمان باقی مانده تا ناپدید شدن رگه ترکیبی شما با نشان داده می شود");
	if (gameState == 1) {
		pause();
	}
